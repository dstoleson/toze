...
public class TozeFontMap
{
   ...
   static Font getFont()
   {
      ...
      try
      {
         ...
         ZipFile zf = new ZipFile("toze.jar");
         ZipEntry ze = zf.getEntry("zfont.ttf");
         InputStream is = zf.getInputStream(ze);
         m_font = Font.createFont(Font.TRUETYPE_FONT, is);

//         m_font = Font.createFont(Font.TRUETYPE_FONT, new FileInputStream("zfont\\zfont.ttf"));
         AffineTransform at = new AffineTransform();
         at.setToScale(20.0, 20.0);
         AffineTransform at2 = new AffineTransform();
         at2.setToTranslation(0.0, 0.15);
         at.concatenate(at2);
         //m_font = m_font.deriveFont((float)20.0);
