...
{
    private static Set<TozeCharMap> all;
    private static TreeMap m_map = null;
    ...
    /**
     * Only access as a static
     */
    private TozeChars()
    {
    }

    public static class TozeMap
    {
        public String tozeChar;
        public int pos;
    }

    public static TozeMap mapLast(String str, int pos)
    {
        TozeMap tozeMap = new TozeMap();
        ...
        if (pos > 0)
            ...
            if (str.charAt(pos - 1) == '%')
                ...
                if (idx > -1)
                    ...
                    if (c != null)
                        {
                        tozeMap.tozeChar = str.substring(0, idx) + c + str.substring(pos);
                        tozeMap.pos = idx + c.length();
                        return tozeMap;
                        }
                    }
                }
