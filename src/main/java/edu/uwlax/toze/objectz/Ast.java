...
public class Ast
{
   static TozeResults              m_results  = new TozeResults();
   static String                   m_strAst   = new String();
   static TozeTypeCheckerListenerX m_ttcl     = null;
   static Vector                   m_allTtcls = new Vector();
   
   static public void setTtcl(TozeTypeCheckerListenerX x)
   {
      m_ttcl = x;
      m_allTtcls.add(x);
   }
   ...
   static public void setFocusTo(String id)
   {
      int i;
      for (i=0; i<m_allTtcls.size(); i++)
      {
         ((TozeTypeCheckerListenerX)m_allTtcls.get(i)).setFocusIfHas(id);
      }
   }
   ...
   public class AstBase
   {
      ...
      {printSpaces(l); System.out.println(text); m_strAst += text + "\n";}
      public void print(int l) { print(l, "no name"); m_strAst += "no name\n";}
   ...
   public class AstSpec extends AstBase
   {
      ...
      public void add(AstBase n)
      {
         if (n instanceof AstPara) m_paras.add((AstPara) n);
         else super.add(n);
      }
      ...
      {
         if (m_stable == null) m_stable = new AstSymbolTable();
         int i;
         for (i=0; i<m_paras.size(); i++)
         {
      ...
      public void checkType()
      {
         ...
         while (true)
         {
	        ...
	        if (!m_stable.m_undefinedSymbolOccurred &&
	            !m_stable.m_undefinedTypeOccurred) break;
	        if (!m_stable.m_newSymbolSet) break; // if no new symbols were defined then break
   ...
   public class AstBasicTypeDefinition extends AstPara
   {
      ...
      private boolean containsId(AstIdentifier id)
      {
         ...
         for (i=0; i<m_identifiers.size(); i++)
         {
            ...
            if (id.m_token.m_value.equals(val)) return true;
         }
         return false;
      }
   ...
   public class AstAxiomaticDefinition extends AstPara
   {
      ...
      public void print(int l)
      {
         ...
         if (m_declaration != null) m_declaration.print(l+1);
         if (m_predicateList != null) m_predicateList.print(l+1);
      }
      ...
      public void add(AstBase n)
      {
         ...
         {
            if (m_predicateList == null) m_predicateList = new AstPredicateList();
      ...
      {
         m_stable = stable;
         if (m_declaration != null) m_declaration.populateTypeTable(m_stable);
         if (m_predicateList != null) m_predicateList.populateTypeTable(m_stable);
      }
      
      public void populateSymbolTable()
      {
         if (m_declaration != null) m_declaration.populateSymbolTable();
         if (m_predicateList != null) m_predicateList.populateSymbolTable();
      }
      
      public void checkType()
      {
         if (m_declaration != null) m_declaration.checkType();
         if (m_predicateList != null) m_predicateList.checkType();
      }
   }
   ...
   public class AstGenericDefinition extends AstPara
   {
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (m_formalParameters != null) m_formalParameters.populateTypeTable(m_stable);
         if (m_declaration != null) m_declaration.populateTypeTable(m_stable);
         if (m_predicateList != null) m_predicateList.populateTypeTable(m_stable);
...
/*
            ...
            {
               AstIdentifier id = (AstIdentifier)m_formalParameters.m_identifiers.get(i);
               AstType type = new AstType(AstType.TYPE_SET);
...
*/
   ...
   public class AstAbbreviationDefinition extends AstPara
   {
      ...
      {
         m_stable = stable;
         if (m_expression != null) m_expression.populateTypeTable(m_stable);
      }
      ...
      public void populateSymbolTable()
      {
         ...
         if (!added) m_abbreviation.checkType();
         if (m_expression != null) m_expression.populateSymbolTable();
      }
   ...
   public class AstFreeTypeDefinition extends AstPara
   {
      ...
      public void print(int l)
      {
         ...
         if (m_identifier != null) m_identifier.print(l+1);
         int i;
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (!added) m_identifier.checkType();
   ...
   public class AstSchema1 extends AstSchema
   {
      ...
      {
         print(l, "Schema");
         if (m_schemaHeader != null) m_schemaHeader.print(l+1);
         if (m_declaration != null) m_declaration.print(l+1);
         if (m_predicateList != null) m_predicateList.print(l+1);
      }
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (m_schemaHeader != null) m_schemaHeader.populateTypeTable(m_stable);
         if (m_declaration != null) m_declaration.populateTypeTable(m_stable);
         if (m_predicateList != null) m_predicateList.populateTypeTable(m_stable);
      }
      ...
      public void populateSymbolTable()
      {
         if (m_schemaHeader != null) m_schemaHeader.populateSymbolTable();
         if (m_declaration != null) m_declaration.populateSymbolTable();
         if (m_predicateList != null) m_predicateList.populateSymbolTable();
      }
   ...
   public class AstClass extends AstPara
   {
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (m_state != null) m_state.populateTypeTable(m_stable);
         if (m_initialState != null) m_initialState.populateTypeTable(m_stable);
      ...
      public void populateSymbolTable()
      {
         ...
         if (m_state != null) m_state.populateSymbolTable();
         if (m_initialState != null) m_initialState.populateSymbolTable();
      ...
      public void checkType()
      {
         ...
         for (i=0; i<m_inheritedClasses.size(); i++)
         {
            ...
            if (t == null)
            {
               ic.reportTypeError(ic.m_className.getName() + " is not defined",
            ...
            else
            {
               if (!t.isClassDef())
               {
                  reportTypeError(ic.m_className.getName() + " must be a class",
                                  ic.m_className.m_token);
                  thisClassOK = false;
               }
            }
            */
            ...
            if (thisClassOK)
            {
               m_stable.add(ic.m_className.getName(), t.getSetType().m_classMembers);
            }
            */
         }
         ...
         if (m_state != null) m_state.checkType();
         if (m_initialState != null) m_initialState.checkType();
         ...
         if (m_visibilityList != null) m_visibilityList.setVisible(m_stable);
      }
   }
   ...
   public class AstInheritedClass extends AstBase
   {
      ...
      {
         m_stable = stable;
         if (m_actualParameters != null) m_actualParameters.populateTypeTable(m_stable);
      }
      
      public void populateTypeTable()
      {
         if (m_actualParameters != null) m_actualParameters.populateSymbolTable();
      }
      ...
      public void checkType()
      {
         ...
         int numParams = 0;
         if (m_actualParameters != null) numParams = m_actualParameters.getNumParams(); 
   ...
   public class AstState extends AstBase
   {
      ...
      public void add(AstBase n)
      {
         if (n instanceof AstDeclaration)
         {
            if (m_declaration == null) m_declaration = (AstDeclaration)n;
            else m_declaration.add(n);
         }
         else if (n instanceof AstPredicateList)
         {
            if (m_predicateList == null) m_predicateList = (AstPredicateList)n;
            else m_predicateList.add(n);
         }
         else if (n instanceof AstPredicate)
         {
            if (m_predicateList == null) m_predicateList = new AstPredicateList();
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         m_stable = stable;
         if (m_declaration != null) m_declaration.populateTypeTable(m_stable);
         if (m_deltaDeclaration != null) m_deltaDeclaration.populateTypeTable(m_stable);
         if (m_predicateList != null) m_predicateList.populateTypeTable(m_stable);
      }
      ...
      {
         if (m_declaration != null) m_declaration.populateSymbolTable();
         if (m_deltaDeclaration != null) m_deltaDeclaration.populateSymbolTable();
         if (m_predicateList != null) m_predicateList.populateSymbolTable();
      }
   ...
   public class AstOperation extends AstBase
   {
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (m_operationName != null) operationName = m_operationName.getName();
         m_stable = new AstSymbolTable(stable);
         ...
         if (m_declaration != null) m_declaration.populateTypeTable(m_stable);
         if (m_predicateList != null) m_predicateList.populateTypeTable(m_stable);
         if (m_operationExpression != null) m_operationExpression.populateTypeTable(m_stable);
      }
      ...
      public void populateSymbolTable()
      {
         ...
         if (!added) m_operationName.checkType();
         if (m_declaration != null) m_declaration.populateSymbolTable();
         if (m_predicateList != null) m_predicateList.populateSymbolTable();
         if (m_operationExpression != null) m_operationExpression.populateSymbolTable();
      }
      ...
      public void checkType()
      {
         if (m_declaration != null) m_declaration.checkType();
         if (m_predicateList != null) m_predicateList.checkType();
         if (m_operationExpression != null) m_operationExpression.checkType();
   ...
   public class AstAbbreviation1 extends AstAbbreviation
   {
      ...
      public void print(int l)
      {
         ...
         if (m_formalParameters != null) m_formalParameters.print(l+1);
      }
   ...
   public class AstBranch1 extends AstBranch
   {
      ...
      public void print(int l)
      {
         if (m_identifier != null) m_identifier.print(l);
      }
   ...
   public class AstSchemaHeader extends AstBase
   {
      ...
      public void populateSymbolTable()
      {
         if (m_formalParameters != null) m_formalParameters.populateSymbolTable();
      }
   }
   ...
   public class AstSchemaReference extends AstBase
   {
      ...
      public void print(int l)
      {
         ...
         if (m_decorations != null) m_decorations.print(l+1);
         if (m_actualParameters != null) m_actualParameters.print(l+1);
         if (m_renameList != null) m_renameList.print(l+1);
      }
      ...
      public void checkType()
      {
         ...
         /*
          * Add a reference to the schema so that its members can be accessed.
          */
   ...
   public class AstDecorations extends AstBase
   {
      ...
      public String getName()
      {
         ...
         {
            if (((Character)m_decorations.get(i)).charValue() != '\'') name += (Character)m_decorations.get(i);
         }
         return name;
      }
   }
   ...
   public class AstVariableName1 extends AstVariableName
   {
      ...
      public String getName()
      {
         if (m_decorations == null) return m_identifier.getName();
   ...
   public class AstIdentifier extends AstBase
   {
      ...
      public String getName()
      {
         if (m_decorations == null) return m_token.m_value;
   ...
   public class AstDeclarationName extends AstBase
   {
      ...
      public TozeToken getToken() { return null; }
   }
   ...
   public class AstSchemaText extends AstBase
   {
      ...
      public void print(int l)
      {
         ...
         if (m_predicate != null) m_predicate.print(l+1);
      }
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         ...
         if (m_predicate != null) m_predicate.populateTypeTable(m_stable);
      }
      
      public void populateSymbolTable()
      {
         m_declaration.populateSymbolTable();
         if (m_predicate != null) m_predicate.populateSymbolTable();
      }
      
      public void checkType()
      {
         m_declaration.checkType();
         if (m_predicate != null) m_predicate.checkType();
      }
   ...
   public class AstDeclaration extends AstBase
   {
      ...
      public AstType getType()
      {
         if (m_decls.size() == 0) return new AstType();
   ...
   public class AstMemberOp extends AstOperationExpression
   {
      ...
      public void populateSymbolTable()
      {
         if (m_member != null) m_member.populateSymbolTable();
      }
      
      public AstType getType()
      {
         if (m_member != null) m_member.checkType();
         return new AstType(AstType.TYPE_BOOL);
      }
   }
   ...
   public class AstRelation extends AstBase
   {
      ...
      public void print(int l)
      {
         if (m_infixRelationName != null) m_infixRelationName.print(l);
         if (m_identifier != null) m_identifier.print(l);
      }
   }
   ...
   public class AstPrefixRelationNameP extends AstPredicate
   {
      ...
      {
         AstType type = m_expression.getType();
         if (!type.isSet()) reportTypeError("Expression for " + m_prefixRelationName.getName() + " must evaluate to a set",
   ...
   public class AstPowerX extends AstExpression
   {
      ...
      public AstType getType()
      {
         ...
         if (ttype.isUndefined()) return new AstType();
      ...
      public AstType getType()
      {
         switch (m_prefixGenericName.m_token.m_id)
         {
            ...
            case TozeTokenizer.TOKEN_ISEQ:
               ...
               if (t.isUndefined()) return new AstType();
//               AstType type = new AstType(AstType.TYPE_SET);
//               type.m_setType = new AstType(AstType.TYPE_SEQUENCE);
               if (t.isSet()) t = t.getSetType();
...
//               type.m_setType = new AstType(AstType.TYPE_BAG);
   ...
   public class AstDistUnionX extends AstExpression
   {
      ...
      {
         AstType type = m_expression.getType();
         if (type.isUndefined()) return new AstType();
         if (type.getType() != AstType.TYPE_SET)
         {
         ...
         if (type.getSetType().getType() == AstType.TYPE_TUPLE)
         {
            ...
            if (stype.m_tupleTypes.size() == 0) return new AstType(AstType.TYPE_EMPTY);
   ...
   public class AstNumberX extends AstExpression
   {
      ...
      public AstType getType()
      {
         ...
         if (m_token.m_value.indexOf('.') >= 0) type.m_type = AstType.TYPE_REAL;
         else type.m_type = AstType.TYPE_NATURAL;
         return type;
      }
   }
   ...
   public class AstDownArrowX extends AstExpression
   {
      ...
      public AstType getType()
      {
         if (m_expression == null) return new AstType();
         return m_expression.getType();
      }
   }
   ...
   public class AstBagX extends AstExpression
   {
      ...
      public AstType getType()
      {
         ...
         if (m_expressions.size() == 0) return new AstType(AstType.TYPE_EMPTY);

         AstType stype = ((AstBase)m_expressions.get(0)).getType();
         if (stype.isUndefined()) return new AstType();
   ...
   public class AstMemberX extends AstExpression
   {
      ...
      public AstType getType()
      {
         ...
         if (ctype.isUndefined()) return new AstType();
         if (ctype == null)
         {
   ...
   public class AstLambdaX extends AstExpression
   {
      ...
      public AstType getType()
      {
         ...
         if (et.isUndefined()) return new AstType();
   ...
   /*
    * This class is a merging of a variable (V), Schema Reference (S), and class (C).
...
/*         if (m_expressions.size() > 1)
         ...
         if (m_expressions.size() != 0)
         {
            ...
            if (type.m_setType.isUndefined()) return new AstType();
         }
         else
         {
            type = new AstType(AstType.TYPE_SET);
   ...
   public class AstSetExpressionX2 extends AstSetExpressionX
   {
      ...
      {
         print(l, "SetExpression");
         if (m_schemaText != null) m_schemaText.print(l+1);
         m_expression.print(l+1);
      }
      ...
      public void populateTypeTable(AstSymbolTable stable)
      {
         m_stable = new AstSymbolTable(stable);
         stable.addKid(m_stable);
         if (m_schemaText != null) m_schemaText.populateTypeTable(m_stable);
         if (m_expression != null) m_expression.populateTypeTable(m_stable);
      }
      
      public void populateSymbolTable()
      {
         if (m_schemaText != null) m_schemaText.populateSymbolTable();
         if (m_expression != null) m_expression.populateSymbolTable();
      }
    
      public AstType getType()
      {
         if (m_schemaText != null) m_schemaText.checkType();
         if (m_expression == null) return m_schemaText.getType();
         AstType type = new AstType(AstType.TYPE_SET);
...
//            return type.m_setType;
             ...
             (m_token.m_id == TozeTokenizer.TOKEN_SECOND))
         {
            ...
            if (m_token.m_id == TozeTokenizer.TOKEN_FIRST) return (AstType)type.m_tupleTypes.get(0);
   ...
   public class AstPrefixGenericName extends AstBase
   {
      ...
      public void print(int l)
      {
         ...
         if (m_decoration != null) m_decoration.print(l+1);
      }
   }
