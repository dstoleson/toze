...
public class AstType
{
    ...
    */
    ...
    public boolean isCompatible(AstType type)
    {
        ...
        if (isSet() && type.isSet())
            ...
            if ((getSetType().getType() == TYPE_EMPTY) ||
                    (type.getSetType().getType() == TYPE_EMPTY))
                {
                return true;
                }
    ...
    public boolean isEqual(AstType type)
    {
        ...
        switch (getType())
            ...
            case TYPE_TUPLE:
                int i;
                if (m_tupleTypes.size() != type.m_tupleTypes.size())
                    {
                    return false;
                    }
    ...
    public boolean isSuperClass(String name)
    {
        ...
        if (m_classMembers != null)
            {
            return m_classMembers.isSuperClass(name);
            }
        return false;
    }
    ...
    public boolean isClassDef()
    {
        ...
        if (m_setType.getType() != TYPE_CLASS)
            {
            return false;
            }
        return true;
    ...
    public boolean isSchemaDef()
    {
        ...
        if (m_setType.getType() != TYPE_SCHEMA)
            {
            return false;
            }
        return true;
    ...
    */
    ...
    public AstType resultantType(AstType type)
    {
        ...
        if (getType() == TYPE_NATURAL)
            {
            if (type.getType() == TYPE_NATURAL)
                {
                newType = TYPE_NATURAL;
                }
            else if (type.getType() == TYPE_NATURAL1)
                {
                newType = TYPE_NATURAL;
                }
            else if (type.getType() == TYPE_NUMBER)
                {
                newType = TYPE_NUMBER;
                }
            else if (type.getType() == TYPE_REAL)
                {
                newType = TYPE_REAL;
                }
            }
    ...
    public boolean isUndefined()
    {
        ...
        if (getType() == TYPE_TUPLE)
            ...
            for (i = 0; i < m_tupleTypes.size(); i++)
                {
                if (((AstType) m_tupleTypes.get(i)).isUndefined())
                    {
                    return true;
                    }
                }
