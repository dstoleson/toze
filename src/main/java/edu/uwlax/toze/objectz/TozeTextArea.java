        ...
        implements TozeTypeCheckerListenerX
{
    ...
    protected void processKeyEvent(KeyEvent e)
    {
        ...
        if (e.getID() == KeyEvent.KEY_PRESSED)
            ...
            /*
             * Check if CTRL-a was pressed. This will bring up the
             * poper popup menu.
             */
            else if (e.getKeyCode() == 65 && e.isControlDown() && !e.isShiftDown())
                {
                getParent().dispatchEvent(new TozeEvent(this, TozeEvent.TOZE_MENU));
                handled = true;
                }
            /*
             * Check if CTRL-c was pressed. This will check the spec.
             */
            else if (e.getKeyCode() == 67 && e.isControlDown() && !e.isShiftDown())
                {
                m_actionSpec.dispatchEvent(new TozeEvent(this, TozeEvent.TOZE_CHECK));
                handled = true;
                }
            }
...
//      }
    ...
    public void paint(Graphics g)
    {
         ...
         * g.drawString(tmp,
         * 0,
         * 5 + ((fm.getHeight() * (ln + 1))- fm.getDescent()));
         * ln++;
         * }
         */
        /*
